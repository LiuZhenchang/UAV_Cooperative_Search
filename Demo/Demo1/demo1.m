...
property.uav.num = 4;                                       % Number of drones
...
property.uav.foresee_traj=0;                                % Whether foresee the path of other UAVs, 0 no, 1 yes
...
property.uav.safe_xg = 2;                                   % The number of safe grids from the UAV to the x boundary of map
property.uav.safe_yg = 2;                                   % The number of safe grids from the UAV to the y boundary of map
property.uav.safe_obs = 20;                                 % Safe distance from the UAV to obstacles
property.uav.safe_uav = 30;                                 % Safe distance between UAVs
property.uav.seeker_type = 1;                               % Types of FOV
...
property.uav.search_jump = 1;                               % Jumping grid number, ultimately determined by the expert system
...
property.obs.r_lim = [20,80];                               % Obstacle radius limitation
